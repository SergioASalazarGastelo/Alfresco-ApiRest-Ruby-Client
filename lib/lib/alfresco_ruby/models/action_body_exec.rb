...
module Alfresco
  ...
  class ActionBodyExec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'actionDefinitionId')
        self.action_definition_id = attributes[:'actionDefinitionId']
      end
    ...
    def valid?
      return false if @action_definition_id.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          action_definition_id == o.action_definition_id &&
    ...
    def hash
      [action_definition_id, target_id, params].hash
    end
