...
module Alfresco
  ...
  class PersonBodyCreate
    ...
    def hash
      [id, first_name, last_name, description, email, skype_id, google_id, instant_message_id, job_title, location, company, mobile, telephone, user_status, enabled, email_notifications_enabled, password, aspect_names, properties].hash
    end
