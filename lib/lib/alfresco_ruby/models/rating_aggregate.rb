...
module Alfresco
  ...
  class RatingAggregate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'numberOfRatings')
        self.number_of_ratings = attributes[:'numberOfRatings']
      end
    ...
    def valid?
      return false if @number_of_ratings.nil?
      return true
    end
    ...
    def hash
      [number_of_ratings, average].hash
    end
