...
module Alfresco
  ...
  class RatingBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'myRating')
        self.my_rating = attributes[:'myRating']
      end
    ...
    def valid?
      ...
      id_validator = EnumAttributeValidator.new('String', ["likes", "fiveStar"])
      return false unless id_validator.valid?(@id)
      return false if @my_rating.nil?
      return true
    end
    ...
    def id=(id)
      validator = EnumAttributeValidator.new('String', ["likes", "fiveStar"])
