...
module Alfresco
  ...
  class Person
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'avatarId')
        self.avatar_id = attributes[:'avatarId']
      end
      ...
      if attributes.has_key?(:'statusUpdatedAt')
        self.status_updated_at = attributes[:'statusUpdatedAt']
      end
    ...
    def hash
      [id, first_name, last_name, display_name, description, avatar_id, email, skype_id, google_id, instant_message_id, job_title, location, company, mobile, telephone, status_updated_at, user_status, enabled, email_notifications_enabled, aspect_names, properties, capabilities].hash
    end
