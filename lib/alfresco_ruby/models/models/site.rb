...
module Alfresco
  ...
  class Site
    ...
    def valid?
      ...
      visibility_validator = EnumAttributeValidator.new('String', ["PRIVATE", "MODERATED", "PUBLIC"])
      return false unless visibility_validator.valid?(@visibility)
      role_validator = EnumAttributeValidator.new('String', ["SiteConsumer", "SiteCollaborator", "SiteContributor", "SiteManager"])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('String', ["PRIVATE", "MODERATED", "PUBLIC"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["SiteConsumer", "SiteCollaborator", "SiteContributor", "SiteManager"])
    ...
    def hash
      [id, guid, title, description, visibility, preset, role].hash
    end
