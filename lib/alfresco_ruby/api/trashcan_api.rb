...
module Alfresco
  class TrashcanApi
    ...
    def get_archived_node_rendition_with_http_info(node_id, rendition_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.get_archived_node_rendition" if node_id.nil?
      # verify the required parameter 'rendition_id' is set
      fail ArgumentError, "Missing the required parameter 'rendition_id' when calling TrashcanApi.get_archived_node_rendition" if rendition_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}/renditions/{renditionId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s).sub('{' + 'renditionId' + '}', rendition_id.to_s)
    ...
    def get_archived_node_rendition_content(node_id, rendition_id, opts = {})
      data, _status_code, _headers = get_archived_node_rendition_content_with_http_info(node_id, rendition_id, opts)
      return data
    end
    ...
    def get_archived_node_rendition_content_with_http_info(node_id, rendition_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.get_archived_node_rendition_content" if node_id.nil?
      # verify the required parameter 'rendition_id' is set
      fail ArgumentError, "Missing the required parameter 'rendition_id' when calling TrashcanApi.get_archived_node_rendition_content" if rendition_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}/renditions/{renditionId}/content".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s).sub('{' + 'renditionId' + '}', rendition_id.to_s)
    ...
    def get_deleted_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.get_deleted_node" if node_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def get_deleted_node_content(node_id, opts = {})
      data, _status_code, _headers = get_deleted_node_content_with_http_info(node_id, opts)
      return data
    end
    ...
    def get_deleted_node_content_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.get_deleted_node_content" if node_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}/content".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def list_deleted_node_renditions_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.list_deleted_node_renditions" if node_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}/renditions".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def list_deleted_nodes_with_http_info(opts = {})
      ...
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling TrashcanApi.list_deleted_nodes, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling TrashcanApi.list_deleted_nodes, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/deleted-nodes".sub('{format}','json')
    ...
    # @option opts [DeletedNodeBodyRestore] :deleted_node_body_restore The targetParentId if the node is restored to a new location.
    # @return [NodeEntry]
    ...
    def restore_deleted_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TrashcanApi.restore_deleted_node" if node_id.nil?
      # resource path
      local_var_path = "/deleted-nodes/{nodeId}/restore".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'deleted_node_body_restore'])
      auth_names = ['basicAuth']
