...
module Alfresco
  class PeopleApi
    ...
    def create_person_with_http_info(person_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_body_create' when calling PeopleApi.create_person" if person_body_create.nil?
      # resource path
      local_var_path = "/people".sub('{format}','json')
    ...
    def delete_avatar_image_with_http_info(person_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.delete_avatar_image" if person_id.nil?
      # resource path
      local_var_path = "/people/{personId}/avatar".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def get_avatar_image(person_id, opts = {})
      data, _status_code, _headers = get_avatar_image_with_http_info(person_id, opts)
      return data
    end
    ...
    def get_avatar_image_with_http_info(person_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.get_avatar_image" if person_id.nil?
      # resource path
      local_var_path = "/people/{personId}/avatar".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def get_person_with_http_info(person_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.get_person" if person_id.nil?
      # resource path
      local_var_path = "/people/{personId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    # @option opts [Array<String>] :include Returns additional information about the person. The following optional fields can be requested: * properties * aspectNames * capabilities 
    # @option opts [Array<String>] :fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
    # @return [PersonPaging]
    ...
    def list_people_with_http_info(opts = {})
      ...
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling PeopleApi.list_people, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling PeopleApi.list_people, must be greater than or equal to 1.0.'
      end
    ...
    def request_password_reset_with_http_info(person_id, client_body, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.request_password_reset" if person_id.nil?
      # verify the required parameter 'client_body' is set
      fail ArgumentError, "Missing the required parameter 'client_body' when calling PeopleApi.request_password_reset" if client_body.nil?
      # resource path
      local_var_path = "/people/{personId}/request-password-reset".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def reset_password_with_http_info(person_id, password_reset_body, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.reset_password" if person_id.nil?
      # verify the required parameter 'password_reset_body' is set
      fail ArgumentError, "Missing the required parameter 'password_reset_body' when calling PeopleApi.reset_password" if password_reset_body.nil?
      # resource path
      local_var_path = "/people/{personId}/reset-password".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def update_avatar_image_with_http_info(person_id, content_body_update, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.update_avatar_image" if person_id.nil?
      # verify the required parameter 'content_body_update' is set
      fail ArgumentError, "Missing the required parameter 'content_body_update' when calling PeopleApi.update_avatar_image" if content_body_update.nil?
      # resource path
      local_var_path = "/people/{personId}/avatar".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def update_person_with_http_info(person_id, person_body_update, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PeopleApi.update_person" if person_id.nil?
      # verify the required parameter 'person_body_update' is set
      fail ArgumentError, "Missing the required parameter 'person_body_update' when calling PeopleApi.update_person" if person_body_update.nil?
      # resource path
      local_var_path = "/people/{personId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
