...
module Alfresco
  class SitesApi
    ...
    # @return [nil]
    def approve_site_membership_request(site_id, invitee_id, opts = {})
      approve_site_membership_request_with_http_info(site_id, invitee_id, opts)
      return nil
    end
    ...
    def approve_site_membership_request_with_http_info(site_id, invitee_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SitesApi.approve_site_membership_request ..."
      end
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.approve_site_membership_request" if site_id.nil?
      # verify the required parameter 'invitee_id' is set
      fail ArgumentError, "Missing the required parameter 'invitee_id' when calling SitesApi.approve_site_membership_request" if invitee_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}/site-membership-requests/{inviteeId}/approve".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'inviteeId' + '}', invitee_id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'site_membership_approval_body'])
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SitesApi#approve_site_membership_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_site_with_http_info(site_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'site_body_create' when calling SitesApi.create_site" if site_body_create.nil?
      # resource path
      local_var_path = "/sites".sub('{format}','json')
    ...
    def create_site_membership_with_http_info(site_id, site_membership_body_create, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.create_site_membership" if site_id.nil?
      # verify the required parameter 'site_membership_body_create' is set
      fail ArgumentError, "Missing the required parameter 'site_membership_body_create' when calling SitesApi.create_site_membership" if site_membership_body_create.nil?
      # resource path
      local_var_path = "/sites/{siteId}/members".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def create_site_membership_request_for_person_with_http_info(person_id, site_membership_request_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.create_site_membership_request_for_person" if person_id.nil?
      # verify the required parameter 'site_membership_request_body_create' is set
      fail ArgumentError, "Missing the required parameter 'site_membership_request_body_create' when calling SitesApi.create_site_membership_request_for_person" if site_membership_request_body_create.nil?
      # resource path
      local_var_path = "/people/{personId}/site-membership-requests".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def delete_site_with_http_info(site_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.delete_site" if site_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def delete_site_membership_with_http_info(site_id, person_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.delete_site_membership" if site_id.nil?
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.delete_site_membership" if person_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}/members/{personId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def delete_site_membership_for_person_with_http_info(person_id, site_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.delete_site_membership_for_person" if person_id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.delete_site_membership_for_person" if site_id.nil?
      # resource path
      local_var_path = "/people/{personId}/sites/{siteId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def delete_site_membership_request_for_person_with_http_info(person_id, site_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.delete_site_membership_request_for_person" if person_id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.delete_site_membership_request_for_person" if site_id.nil?
      # resource path
      local_var_path = "/people/{personId}/site-membership-requests/{siteId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def get_site_with_http_info(site_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.get_site" if site_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def get_site_container_with_http_info(site_id, container_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.get_site_container" if site_id.nil?
      # verify the required parameter 'container_id' is set
      fail ArgumentError, "Missing the required parameter 'container_id' when calling SitesApi.get_site_container" if container_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}/containers/{containerId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'containerId' + '}', container_id.to_s)
    ...
    def get_site_membership_with_http_info(site_id, person_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.get_site_membership" if site_id.nil?
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.get_site_membership" if person_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}/members/{personId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def get_site_membership_for_person_with_http_info(person_id, site_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.get_site_membership_for_person" if person_id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.get_site_membership_for_person" if site_id.nil?
      # resource path
      local_var_path = "/people/{personId}/sites/{siteId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def get_site_membership_request_for_person_with_http_info(person_id, site_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.get_site_membership_request_for_person" if person_id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.get_site_membership_request_for_person" if site_id.nil?
      # resource path
      local_var_path = "/people/{personId}/site-membership-requests/{siteId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def get_site_membership_requests(opts = {})
      data, _status_code, _headers = get_site_membership_requests_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :where A string to restrict the returned objects by using a predicate.
    # @option opts [Array<String>] :fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
    # @return [Array<(SiteMembershipRequestWithPersonPaging, Fixnum, Hash)>] SiteMembershipRequestWithPersonPaging data, response status code and response headers
    def get_site_membership_requests_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SitesApi.get_site_membership_requests ..."
      end
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.get_site_membership_requests, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.get_site_membership_requests, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/site-membership-requests".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'SiteMembershipRequestWithPersonPaging')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SitesApi#get_site_membership_requests\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_site_containers_with_http_info(site_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.list_site_containers" if site_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.list_site_containers, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.list_site_containers, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/sites/{siteId}/containers".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def list_site_membership_requests_for_person_with_http_info(person_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.list_site_membership_requests_for_person" if person_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.list_site_membership_requests_for_person, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.list_site_membership_requests_for_person, must be greater than or equal to 1.0.'
      end
    ...
    def list_site_memberships_with_http_info(site_id, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.list_site_memberships" if site_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.list_site_memberships, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.list_site_memberships, must be greater than or equal to 1.0.'
      end
    ...
    def list_site_memberships_for_person_with_http_info(person_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.list_site_memberships_for_person" if person_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.list_site_memberships_for_person, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.list_site_memberships_for_person, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/people/{personId}/sites".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def list_sites_with_http_info(opts = {})
      ...
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SitesApi.list_sites, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SitesApi.list_sites, must be greater than or equal to 1.0.'
      end
    ...
    # @return [nil]
    def reject_site_membership_request(site_id, invitee_id, opts = {})
      reject_site_membership_request_with_http_info(site_id, invitee_id, opts)
      return nil
    end
    ...
    # @option opts [SiteMembershipRejectionBody] :site_membership_rejection_body Rejecting a request to join, optionally, allows the inclusion of comment. 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def reject_site_membership_request_with_http_info(site_id, invitee_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SitesApi.reject_site_membership_request ..."
      end
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.reject_site_membership_request" if site_id.nil?
      # verify the required parameter 'invitee_id' is set
      fail ArgumentError, "Missing the required parameter 'invitee_id' when calling SitesApi.reject_site_membership_request" if invitee_id.nil?
      # resource path
      local_var_path = "/sites/{siteId}/site-membership-requests/{inviteeId}/reject".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'inviteeId' + '}', invitee_id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'site_membership_rejection_body'])
      auth_names = ['basicAuth']
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SitesApi#reject_site_membership_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_site_with_http_info(site_id, site_body_update, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.update_site" if site_id.nil?
      # verify the required parameter 'site_body_update' is set
      fail ArgumentError, "Missing the required parameter 'site_body_update' when calling SitesApi.update_site" if site_body_update.nil?
      # resource path
      local_var_path = "/sites/{siteId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s)
    ...
    def update_site_membership_with_http_info(site_id, person_id, site_membership_body_update, opts = {})
      ...
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.update_site_membership" if site_id.nil?
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.update_site_membership" if person_id.nil?
      # verify the required parameter 'site_membership_body_update' is set
      fail ArgumentError, "Missing the required parameter 'site_membership_body_update' when calling SitesApi.update_site_membership" if site_membership_body_update.nil?
      # resource path
      local_var_path = "/sites/{siteId}/members/{personId}".sub('{format}','json').sub('{' + 'siteId' + '}', site_id.to_s).sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def update_site_membership_request_for_person_with_http_info(person_id, site_id, site_membership_request_body_update, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling SitesApi.update_site_membership_request_for_person" if person_id.nil?
      # verify the required parameter 'site_id' is set
      fail ArgumentError, "Missing the required parameter 'site_id' when calling SitesApi.update_site_membership_request_for_person" if site_id.nil?
      # verify the required parameter 'site_membership_request_body_update' is set
      fail ArgumentError, "Missing the required parameter 'site_membership_request_body_update' when calling SitesApi.update_site_membership_request_for_person" if site_membership_request_body_update.nil?
      # resource path
      local_var_path = "/people/{personId}/site-membership-requests/{siteId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'siteId' + '}', site_id.to_s)
