...
module SwaggerClient
  ...
  class NodeBodyCreate
    ...
    attr_accessor :secondary_children
    ...
    def self.swagger_types
      {
        ...
        :'secondary_children' => :'Array<ChildAssociationBody>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relativePath')
      ...
      if attributes.has_key?(:'secondaryChildren')
        if (value = attributes[:'secondaryChildren']).is_a?(Array)
          self.secondary_children = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          secondary_children == o.secondary_children &&
          targets == o.targets
    end
    ...
    def hash
      [name, node_type, aspect_names, properties, permissions, relative_path, association, secondary_children, targets].hash
    end
