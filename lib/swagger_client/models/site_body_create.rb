...
module SwaggerClient
  ...
  class SiteBodyCreate
    ...
    def valid?
      ...
      visibility_validator = EnumAttributeValidator.new('String', ["PUBLIC", "PRIVATE", "MODERATED"])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('String', ["PUBLIC", "PRIVATE", "MODERATED"])
    ...
    def hash
      [id, title, description, visibility].hash
    end
