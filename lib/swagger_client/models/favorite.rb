...
module SwaggerClient
  ...
  class Favorite
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'targetGuid')
        self.target_guid = attributes[:'targetGuid']
      end
    ...
    def valid?
      return false if @target_guid.nil?
    ...
    def hash
      [target_guid, created_at, target, properties].hash
    end
