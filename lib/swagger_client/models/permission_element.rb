...
module SwaggerClient
  ...
  class PermissionElement
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorityId')
        self.authority_id = attributes[:'authorityId']
      end
      ...
      if attributes.has_key?(:'accessStatus')
        self.access_status = attributes[:'accessStatus']
      else
    ...
    def valid?
      access_status_validator = EnumAttributeValidator.new('String', ["ALLOWED", "DENIED"])
    ...
    def access_status=(access_status)
      validator = EnumAttributeValidator.new('String', ["ALLOWED", "DENIED"])
    ...
    def hash
      [authority_id, name, access_status].hash
    end
