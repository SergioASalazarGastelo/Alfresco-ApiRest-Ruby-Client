...
module SwaggerClient
  class SharedlinksApi
    ...
    # @option opts [Array<String>] :include Returns additional information about the shared link, the following optional fields can be requested: * allowableOperations * path * properties * isFavorite * aspectNames 
    ...
    def create_shared_link_with_http_info(shared_link_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'shared_link_body_create' when calling SharedlinksApi.create_shared_link" if shared_link_body_create.nil?
      # resource path
      local_var_path = "/shared-links".sub('{format}','json')
    ...
    def delete_shared_link_with_http_info(shared_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.delete_shared_link" if shared_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s)
    ...
    def email_shared_link_with_http_info(shared_id, shared_link_body_email, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.email_shared_link" if shared_id.nil?
      # verify the required parameter 'shared_link_body_email' is set
      fail ArgumentError, "Missing the required parameter 'shared_link_body_email' when calling SharedlinksApi.email_shared_link" if shared_link_body_email.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}/email".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s)
    ...
    def get_shared_link_with_http_info(shared_id, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.get_shared_link" if shared_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s)
    ...
    def get_shared_link_content(shared_id, opts = {})
      data, _status_code, _headers = get_shared_link_content_with_http_info(shared_id, opts)
      return data
    end
    ...
    def get_shared_link_content_with_http_info(shared_id, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.get_shared_link_content" if shared_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}/content".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s)
    ...
    def get_shared_link_rendition_with_http_info(shared_id, rendition_id, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.get_shared_link_rendition" if shared_id.nil?
      # verify the required parameter 'rendition_id' is set
      fail ArgumentError, "Missing the required parameter 'rendition_id' when calling SharedlinksApi.get_shared_link_rendition" if rendition_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}/renditions/{renditionId}".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s).sub('{' + 'renditionId' + '}', rendition_id.to_s)
    ...
    def get_shared_link_rendition_content(shared_id, rendition_id, opts = {})
      data, _status_code, _headers = get_shared_link_rendition_content_with_http_info(shared_id, rendition_id, opts)
      return data
    end
    ...
    def get_shared_link_rendition_content_with_http_info(shared_id, rendition_id, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.get_shared_link_rendition_content" if shared_id.nil?
      # verify the required parameter 'rendition_id' is set
      fail ArgumentError, "Missing the required parameter 'rendition_id' when calling SharedlinksApi.get_shared_link_rendition_content" if rendition_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}/renditions/{renditionId}/content".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s).sub('{' + 'renditionId' + '}', rendition_id.to_s)
    ...
    def list_shared_link_renditions_with_http_info(shared_id, opts = {})
      ...
      # verify the required parameter 'shared_id' is set
      fail ArgumentError, "Missing the required parameter 'shared_id' when calling SharedlinksApi.list_shared_link_renditions" if shared_id.nil?
      # resource path
      local_var_path = "/shared-links/{sharedId}/renditions".sub('{format}','json').sub('{' + 'sharedId' + '}', shared_id.to_s)
    ...
    def list_shared_links_with_http_info(opts = {})
      ...
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling SharedlinksApi.list_shared_links, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling SharedlinksApi.list_shared_links, must be greater than or equal to 1.0.'
      end
