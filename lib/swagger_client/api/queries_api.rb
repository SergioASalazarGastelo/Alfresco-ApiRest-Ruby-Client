...
module SwaggerClient
  class QueriesApi
    ...
    def find_people_with_http_info(term, opts = {})
      ...
      # verify the required parameter 'term' is set
      fail ArgumentError, "Missing the required parameter 'term' when calling QueriesApi.find_people" if term.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling QueriesApi.find_people, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling QueriesApi.find_people, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/queries/people".sub('{format}','json')
    ...
    def find_sites_with_http_info(term, opts = {})
      ...
      # verify the required parameter 'term' is set
      fail ArgumentError, "Missing the required parameter 'term' when calling QueriesApi.find_sites" if term.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling QueriesApi.find_sites, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling QueriesApi.find_sites, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/queries/sites".sub('{format}','json')
