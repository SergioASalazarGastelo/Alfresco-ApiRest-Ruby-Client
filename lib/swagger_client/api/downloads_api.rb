...
module SwaggerClient
  class DownloadsApi
    ...
    def cancel_download_with_http_info(download_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'download_id' when calling DownloadsApi.cancel_download" if download_id.nil?
      # resource path
    ...
    def create_download_with_http_info(download_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'download_body_create' when calling DownloadsApi.create_download" if download_body_create.nil?
      # resource path
      local_var_path = "/downloads".sub('{format}','json')
