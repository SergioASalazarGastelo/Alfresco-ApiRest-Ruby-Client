...
module SwaggerClient
  class PreferencesApi
    ...
    def get_preference_with_http_info(person_id, preference_name, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PreferencesApi.get_preference" if person_id.nil?
      # verify the required parameter 'preference_name' is set
      fail ArgumentError, "Missing the required parameter 'preference_name' when calling PreferencesApi.get_preference" if preference_name.nil?
      # resource path
      local_var_path = "/people/{personId}/preferences/{preferenceName}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'preferenceName' + '}', preference_name.to_s)
    ...
    def list_preferences_with_http_info(person_id, opts = {})
      ...
      # verify the required parameter 'person_id' is set
      fail ArgumentError, "Missing the required parameter 'person_id' when calling PreferencesApi.list_preferences" if person_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling PreferencesApi.list_preferences, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling PreferencesApi.list_preferences, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/people/{personId}/preferences".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
