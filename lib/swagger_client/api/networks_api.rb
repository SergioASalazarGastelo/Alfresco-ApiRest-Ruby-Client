...
module SwaggerClient
  class NetworksApi
    ...
    def get_network_for_person_with_http_info(person_id, network_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_id' when calling NetworksApi.get_network_for_person" if person_id.nil?
      # verify the required parameter 'network_id' is set
      fail ArgumentError, "Missing the required parameter 'network_id' when calling NetworksApi.get_network_for_person" if network_id.nil?
      # resource path
      local_var_path = "/people/{personId}/networks/{networkId}".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s).sub('{' + 'networkId' + '}', network_id.to_s)
