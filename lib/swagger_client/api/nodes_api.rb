...
module SwaggerClient
  class NodesApi
    ...
    # @option opts [Array<String>] :include Returns additional information about the node. The following optional fields can be requested: * allowableOperations * association * isLink * isFavorite * isLocked * path * permissions 
    ...
    def copy_node_with_http_info(node_id, node_body_copy, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.copy_node" if node_id.nil?
      # verify the required parameter 'node_body_copy' is set
      fail ArgumentError, "Missing the required parameter 'node_body_copy' when calling NodesApi.copy_node" if node_body_copy.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/copy".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def create_association(node_id, association_body_create, opts = {})
      data, _status_code, _headers = create_association_with_http_info(node_id, association_body_create, opts)
      return data
    end
    ...
    def create_association_with_http_info(node_id, association_body_create, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NodesApi.create_association ..."
      end
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.create_association" if node_id.nil?
      # verify the required parameter 'association_body_create' is set
      fail ArgumentError, "Missing the required parameter 'association_body_create' when calling NodesApi.create_association" if association_body_create.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/targets".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodesApi#create_association\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_node_with_http_info(node_id, node_body_create, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.create_node" if node_id.nil?
      # verify the required parameter 'node_body_create' is set
      fail ArgumentError, "Missing the required parameter 'node_body_create' when calling NodesApi.create_node" if node_body_create.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/children".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
      ...
      # HTTP header 'Content-Type'
      local_header_content_type = ['application/json', 'multipart/form-data']
      header_params['Content-Type'] = @api_client.select_header_content_type(local_header_content_type)
    ...
    def create_secondary_child_association(node_id, secondary_child_association_body_create, opts = {})
      data, _status_code, _headers = create_secondary_child_association_with_http_info(node_id, secondary_child_association_body_create, opts)
      return data
    end
    ...
    def create_secondary_child_association_with_http_info(node_id, secondary_child_association_body_create, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NodesApi.create_secondary_child_association ..."
      end
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.create_secondary_child_association" if node_id.nil?
      # verify the required parameter 'secondary_child_association_body_create' is set
      fail ArgumentError, "Missing the required parameter 'secondary_child_association_body_create' when calling NodesApi.create_secondary_child_association" if secondary_child_association_body_create.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/secondary-children".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodesApi#create_secondary_child_association\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [nil]
    def delete_association(node_id, target_id, opts = {})
      delete_association_with_http_info(node_id, target_id, opts)
      return nil
    end
    ...
    def delete_association_with_http_info(node_id, target_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NodesApi.delete_association ..."
      end
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.delete_association" if node_id.nil?
      # verify the required parameter 'target_id' is set
      fail ArgumentError, "Missing the required parameter 'target_id' when calling NodesApi.delete_association" if target_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/targets/{targetId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s).sub('{' + 'targetId' + '}', target_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodesApi#delete_association\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.delete_node" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    # @option opts [String] :assoc_type Only delete associations of this type.
    # @return [nil]
    def delete_secondary_child_association(node_id, child_id, opts = {})
      delete_secondary_child_association_with_http_info(node_id, child_id, opts)
      return nil
    end
    ...
    # @option opts [String] :assoc_type Only delete associations of this type.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def delete_secondary_child_association_with_http_info(node_id, child_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NodesApi.delete_secondary_child_association ..."
      end
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.delete_secondary_child_association" if node_id.nil?
      # verify the required parameter 'child_id' is set
      fail ArgumentError, "Missing the required parameter 'child_id' when calling NodesApi.delete_secondary_child_association" if child_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/secondary-children/{childId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s).sub('{' + 'childId' + '}', child_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodesApi#delete_secondary_child_association\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.get_node" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def get_node_content(node_id, opts = {})
      data, _status_code, _headers = get_node_content_with_http_info(node_id, opts)
      return data
    end
    ...
    def get_node_content_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.get_node_content" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/content".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    # @option opts [Array<String>] :include Returns additional information about the node. The following optional fields can be requested: * allowableOperations * aspectNames * association * isLink * isFavorite * isLocked * path * properties * permissions 
    ...
    def list_node_children_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.list_node_children" if node_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling NodesApi.list_node_children, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling NodesApi.list_node_children, must be greater than or equal to 1.0.'
      end
    ...
    # @option opts [Array<String>] :include Returns additional information about the node. The following optional fields can be requested: * allowableOperations * aspectNames * isLink * isFavorite * isLocked * path * properties 
    # @option opts [Integer] :skip_count The number of entities that exist in the collection before those included in this list.  If not supplied then the default value is 0.  (default to 0)
    # @option opts [Integer] :max_items The maximum number of items to return in the list.  If not supplied then the default value is 100.  (default to 100)
    ...
    def list_parents_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.list_parents" if node_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling NodesApi.list_parents, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling NodesApi.list_parents, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/nodes/{nodeId}/parents".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def list_secondary_children_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.list_secondary_children" if node_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling NodesApi.list_secondary_children, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling NodesApi.list_secondary_children, must be greater than or equal to 1.0.'
      end
    ...
    def list_source_associations_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.list_source_associations" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/sources".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def list_target_associations_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.list_target_associations" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/targets".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def lock_node_with_http_info(node_id, node_body_lock, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.lock_node" if node_id.nil?
      # verify the required parameter 'node_body_lock' is set
      fail ArgumentError, "Missing the required parameter 'node_body_lock' when calling NodesApi.lock_node" if node_body_lock.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/lock".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def move_node_with_http_info(node_id, node_body_move, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.move_node" if node_id.nil?
      # verify the required parameter 'node_body_move' is set
      fail ArgumentError, "Missing the required parameter 'node_body_move' when calling NodesApi.move_node" if node_body_move.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/move".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def unlock_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.unlock_node" if node_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/unlock".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def update_node_with_http_info(node_id, node_body_update, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.update_node" if node_id.nil?
      # verify the required parameter 'node_body_update' is set
      fail ArgumentError, "Missing the required parameter 'node_body_update' when calling NodesApi.update_node" if node_body_update.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def update_node_content_with_http_info(node_id, content_body_update, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling NodesApi.update_node_content" if node_id.nil?
      # verify the required parameter 'content_body_update' is set
      fail ArgumentError, "Missing the required parameter 'content_body_update' when calling NodesApi.update_node_content" if content_body_update.nil?
      if !opts[:'name'].nil? && opts[:'name'] !~ Regexp.new(^(?!(.*[\\\"\\*\\\\\\>\\<\\?/\\:\\|]+.*)|(.*[\\.]?.*[\\.]+$)|(.*[ ]+$)))
      ...
      # HTTP header 'Content-Type'
      local_header_content_type = ['application/octet-stream']
      header_params['Content-Type'] = @api_client.select_header_content_type(local_header_content_type)
