...
module SwaggerClient
  class TagsApi
    ...
    def create_tag_for_node_with_http_info(node_id, tag_body_create, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TagsApi.create_tag_for_node" if node_id.nil?
      # verify the required parameter 'tag_body_create' is set
      fail ArgumentError, "Missing the required parameter 'tag_body_create' when calling TagsApi.create_tag_for_node" if tag_body_create.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/tags".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def delete_tag_from_node_with_http_info(node_id, tag_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TagsApi.delete_tag_from_node" if node_id.nil?
      # verify the required parameter 'tag_id' is set
      fail ArgumentError, "Missing the required parameter 'tag_id' when calling TagsApi.delete_tag_from_node" if tag_id.nil?
      # resource path
      local_var_path = "/nodes/{nodeId}/tags/{tagId}".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s).sub('{' + 'tagId' + '}', tag_id.to_s)
    ...
    def list_tags_for_node_with_http_info(node_id, opts = {})
      ...
      # verify the required parameter 'node_id' is set
      fail ArgumentError, "Missing the required parameter 'node_id' when calling TagsApi.list_tags_for_node" if node_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling TagsApi.list_tags_for_node, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling TagsApi.list_tags_for_node, must be greater than or equal to 1.0.'
      end
