...
module SwaggerClient
  class GroupsApi
    ...
    def delete_group_membership_with_http_info(group_id, group_member_id, opts = {})
      ...
      # verify the required parameter 'group_id' is set
      fail ArgumentError, "Missing the required parameter 'group_id' when calling GroupsApi.delete_group_membership" if group_id.nil?
      # verify the required parameter 'group_member_id' is set
      fail ArgumentError, "Missing the required parameter 'group_member_id' when calling GroupsApi.delete_group_membership" if group_member_id.nil?
      # resource path
      local_var_path = "/groups/{groupId}/members/{groupMemberId}".sub('{format}','json').sub('{' + 'groupId' + '}', group_id.to_s).sub('{' + 'groupMemberId' + '}', group_member_id.to_s)
    ...
    def list_group_memberships_for_person_with_http_info(person_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'person_id' when calling GroupsApi.list_group_memberships_for_person" if person_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling GroupsApi.list_group_memberships_for_person, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling GroupsApi.list_group_memberships_for_person, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/people/{personId}/groups".sub('{format}','json').sub('{' + 'personId' + '}', person_id.to_s)
    ...
    def list_groups_with_http_info(opts = {})
      ...
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling GroupsApi.list_groups, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling GroupsApi.list_groups, must be greater than or equal to 1.0.'
      end
