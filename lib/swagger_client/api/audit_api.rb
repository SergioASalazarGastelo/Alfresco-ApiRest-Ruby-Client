...
module SwaggerClient
  class AuditApi
    ...
    def delete_audit_entries_for_audit_app_with_http_info(audit_application_id, where, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'audit_application_id' when calling AuditApi.delete_audit_entries_for_audit_app" if audit_application_id.nil?
      # verify the required parameter 'where' is set
      fail ArgumentError, "Missing the required parameter 'where' when calling AuditApi.delete_audit_entries_for_audit_app" if where.nil?
      # resource path
    ...
    def delete_audit_entry_with_http_info(audit_application_id, audit_entry_id, opts = {})
      ...
      # verify the required parameter 'audit_application_id' is set
      fail ArgumentError, "Missing the required parameter 'audit_application_id' when calling AuditApi.delete_audit_entry" if audit_application_id.nil?
      # verify the required parameter 'audit_entry_id' is set
      fail ArgumentError, "Missing the required parameter 'audit_entry_id' when calling AuditApi.delete_audit_entry" if audit_entry_id.nil?
      # resource path
      local_var_path = "/audit-applications/{auditApplicationId}/audit-entries/{auditEntryId}".sub('{format}','json').sub('{' + 'auditApplicationId' + '}', audit_application_id.to_s).sub('{' + 'auditEntryId' + '}', audit_entry_id.to_s)
    ...
    def get_audit_entry_with_http_info(audit_application_id, audit_entry_id, opts = {})
      ...
      # verify the required parameter 'audit_application_id' is set
      fail ArgumentError, "Missing the required parameter 'audit_application_id' when calling AuditApi.get_audit_entry" if audit_application_id.nil?
      # verify the required parameter 'audit_entry_id' is set
      fail ArgumentError, "Missing the required parameter 'audit_entry_id' when calling AuditApi.get_audit_entry" if audit_entry_id.nil?
      # resource path
      local_var_path = "/audit-applications/{auditApplicationId}/audit-entries/{auditEntryId}".sub('{format}','json').sub('{' + 'auditApplicationId' + '}', audit_application_id.to_s).sub('{' + 'auditEntryId' + '}', audit_entry_id.to_s)
    ...
    def list_audit_entries_for_node_with_http_info(node_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'node_id' when calling AuditApi.list_audit_entries_for_node" if node_id.nil?
      if !opts[:'skip_count'].nil? && opts[:'skip_count'] < 0.0
        fail ArgumentError, 'invalid value for "opts[:"skip_count"]" when calling AuditApi.list_audit_entries_for_node, must be greater than or equal to 0.0.'
      end

      if !opts[:'max_items'].nil? && opts[:'max_items'] < 1.0
        fail ArgumentError, 'invalid value for "opts[:"max_items"]" when calling AuditApi.list_audit_entries_for_node, must be greater than or equal to 1.0.'
      end

      # resource path
      local_var_path = "/nodes/{nodeId}/audit-entries".sub('{format}','json').sub('{' + 'nodeId' + '}', node_id.to_s)
    ...
    def update_audit_app_with_http_info(audit_application_id, audit_app_body_update, opts = {})
      ...
      # verify the required parameter 'audit_application_id' is set
      fail ArgumentError, "Missing the required parameter 'audit_application_id' when calling AuditApi.update_audit_app" if audit_application_id.nil?
      # verify the required parameter 'audit_app_body_update' is set
      fail ArgumentError, "Missing the required parameter 'audit_app_body_update' when calling AuditApi.update_audit_app" if audit_app_body_update.nil?
      # resource path
      local_var_path = "/audit-applications/{auditApplicationId}".sub('{format}','json').sub('{' + 'auditApplicationId' + '}', audit_application_id.to_s)
