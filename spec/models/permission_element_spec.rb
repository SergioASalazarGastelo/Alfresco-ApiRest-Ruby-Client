...
# Unit tests for SwaggerClient::PermissionElement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PermissionElement' do
  before do
    # run before each test
    @instance = SwaggerClient::PermissionElement.new
  end
  ...
  describe 'test an instance of PermissionElement' do
    it 'should create an instact of PermissionElement' do
      expect(@instance).to be_instance_of(SwaggerClient::PermissionElement)
    end
  end
