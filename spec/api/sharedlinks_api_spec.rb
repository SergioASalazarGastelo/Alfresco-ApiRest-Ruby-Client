...
# Unit tests for SwaggerClient::SharedlinksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedlinksApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedlinksApi.new
  end
  ...
  describe 'test an instance of SharedlinksApi' do
    it 'should create an instact of SharedlinksApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedlinksApi)
    end
  end
