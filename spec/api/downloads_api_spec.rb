...
# Unit tests for SwaggerClient::DownloadsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DownloadsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DownloadsApi.new
  end
  ...
  describe 'test an instance of DownloadsApi' do
    it 'should create an instact of DownloadsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DownloadsApi)
    end
  end
