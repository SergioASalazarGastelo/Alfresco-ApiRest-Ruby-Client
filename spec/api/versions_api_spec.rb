...
# Unit tests for SwaggerClient::VersionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VersionsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VersionsApi.new
  end
  ...
  describe 'test an instance of VersionsApi' do
    it 'should create an instact of VersionsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::VersionsApi)
    end
  end
