...
# Unit tests for SwaggerClient::RenditionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RenditionsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RenditionsApi.new
  end
  ...
  describe 'test an instance of RenditionsApi' do
    it 'should create an instact of RenditionsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RenditionsApi)
    end
  end
