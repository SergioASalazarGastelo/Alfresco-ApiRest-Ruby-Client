...
# Unit tests for SwaggerClient::FavoritesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FavoritesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::FavoritesApi.new
  end
  ...
  describe 'test an instance of FavoritesApi' do
    it 'should create an instact of FavoritesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::FavoritesApi)
    end
  end
