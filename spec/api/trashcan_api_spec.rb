...
# Unit tests for SwaggerClient::TrashcanApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrashcanApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TrashcanApi.new
  end
  ...
  describe 'test an instance of TrashcanApi' do
    it 'should create an instact of TrashcanApi' do
      expect(@instance).to be_instance_of(SwaggerClient::TrashcanApi)
    end
  end
