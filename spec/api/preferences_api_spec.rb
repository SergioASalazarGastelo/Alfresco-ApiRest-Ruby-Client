...
# Unit tests for SwaggerClient::PreferencesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PreferencesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PreferencesApi.new
  end
  ...
  describe 'test an instance of PreferencesApi' do
    it 'should create an instact of PreferencesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PreferencesApi)
    end
  end
