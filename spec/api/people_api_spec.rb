...
# Unit tests for SwaggerClient::PeopleApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PeopleApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PeopleApi.new
  end
  ...
  describe 'test an instance of PeopleApi' do
    it 'should create an instact of PeopleApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PeopleApi)
    end
  end
