...
describe 'NodesApi' do
  ...
  # unit tests for create_secondary_child_association
  ...
  describe 'create_secondary_child_association test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_association
  ...
  # @return [nil]
  describe 'delete_association test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for delete_secondary_child_association
  ...
  # @option opts [String] :assoc_type Only delete associations of this type.
  # @return [nil]
  describe 'delete_secondary_child_association test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
